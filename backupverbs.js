...
router.get("/", function (request, response, next) {
  var query =
    "SELECT id, verb, verb_order, translation FROM verbs ORDER BY verb_order DESC";

  database.query(query, (err, data) => {
    if (err) {
      throw err;
    }
    response.render("verbs", {
...
//
//
router.get("/verbs/byLetter/:letter", function (request, response, next) {
  const alpha = [
    "A",
    "B",
    "C",
  ...
  //console.log("letter");
  var query =
    "SELECT id, verb, verb_order, translation FROM verbs WHERE LOWER(verbs.verb) LIKE 'a%' ORDER BY verb_order DESC";
...
router.get("/edit/:id", function (req, res, next) {
  ...
  var query = `SELECT * FROM verbs WHERE id = "${id}"`;
